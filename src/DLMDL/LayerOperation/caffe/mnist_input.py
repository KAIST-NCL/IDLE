...
#TODO: mnist input(data_path in learning_option) with only LMDB format
...
class op_caffe_mnist_input(LayerOperation):
    ...
    def compile_time_operation(self, learning_option, cluster):
        ...
        # get attr
        # required field
        backend_idx = 1 #fixed: MNIST with LMDB
        image_size = [batch_size, 1, 28, 28] #fixed: MNIST dataset
