...
#TODO: glaucoma input(data_path in learning_option) from pdxen.
#TODO: current input data format is .npy binary. It must be coverted into LMDB/LEVELDB format
class op_caffe_glaucoma_input(LayerOperation):
    _attributes = """[]""" # TODO: TO BE DEPRECATED

    def compile_time_operation(self, learning_option, cluster):
        """
        define input placeholder for glaucoma input.
        assume that input dataset with LMDB format.
        """
        ...
        # get attr
        # required field
        backend_idx = 1 #fixed: glaucoma with LMDB
        image_size = [batch_size, 3, 256, 256] #fixed: glaucoma dataset
